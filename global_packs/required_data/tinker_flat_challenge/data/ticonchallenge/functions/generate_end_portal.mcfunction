...
execute if score DummyPlayer endPortalGen matches 1 run schedule function ticonchallenge:actually_generate_portal 5s
execute if score DummyPlayer endPortalGen matches 1 run schedule function ticonchallenge:lightning_bolt 1s
